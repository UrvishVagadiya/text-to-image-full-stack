...
const Testimonials = () => {
  return (
    ...
    <p className='text-grey-500 mb-'>What Our Users Are Saying</p>
            ...
            <div className='flex flex-col items-center'>
                ...
                <div className='flex mb-4'>
                    {Array(testimonial.stars).fill().map((item,index)=>(
                        <img key={index} src={assets.star_icon} width={18} alt="" />

                    ))}
                </div>
                <p className='text-center text-sm text-grey-600'>{testimonial.text}</p>
            </div>
        </div>
    ))}
    </div>
